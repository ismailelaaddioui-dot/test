...
COMPANIES = [
    # 1A
    Company("Raccoon London", "1A", "UK"),
    Company("North Six", "1A", "US"),
    Company("Factor Fifty", "1A", "UK"),
    Company("Production Paradise", "1A", "UK"),
    Company("Le Book", "1A", "US"),
    # 1B
    Company("Studio Black Tomato", "1B", "UK"),
    Company("80 DAYS", "1B", "UK"),
    Company("Spherical", "1B", "UK"),
    Company("Mason Circle", "1B", "UK"),
    Company("Imperial Leisure", "1B", "UK"),
    Company("mr.h", "1B", "UK"),
    Company("Sparkloft", "1B", "US"),
    Company("VERB", "1B", "US"),
    # 1C
    Company("Wieden+Kennedy", "1C", "UK"),
    Company("Mother", "1C", "UK"),
    Company("BBH", "1C", "UK"),
    Company("adam&eveDDB", "1C", "UK"),
    Company("Droga5", "1C", "US"),
    Company("AMV BBDO", "1C", "UK"),
    Company("Ogilvy", "1C", "UK"),
    Company("We Are Social", "1C", "UK"),
    Company("BETC", "1C", "France"),
    Company("Publicis", "1C", "France"),
    Company("Marcel", "1C", "France"),
]
